...
export function ProductCatalog({ products, categories, locale, filterable = false }: { products: Product[]; categories: Category[]; locale: Locale; filterable?: boolean }) {
  ...
  return <>
    ...
    <section className="product-grid" aria-label={cn ? "产品目录" : "Product catalog"}>
